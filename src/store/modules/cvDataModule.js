          ...
          modules: [
            {
              ...
              mainResponsibilities: ["Регистрация", "Анализ", "Кореспонденция"]
            }
          ]
        },
        {
          ...
          modules: [
            {
              ...
              city: "Търговище",
              mainResponsibilitiesTitle: "Основни задължения:",
              mainResponsibilities: ["Приемане и предаване на товари", "Касиер"]
            }
          ]
        },
        {
  ...
  education: [
    {
      ...
      educationData: [
        ...
        },
        {
          ...
          city: "Targovishte",
          mainCourses: ["Пathematics", "English", "Russian"]
        }
      ]
    },
    {
      ...
      educationData: [
        ...
        },
        {
          ...
          city: "Търговище",
          mainCourses: ["Математика", "Английски", "Руски"]
        }
      ]
    }
  ],
  portfolio: [
    {
      ...
      lang: "en",
      title: "Portfolio",
      link: "https://rosen-mihaylov-portfolio.netlify.com/"
    },
    {
      id: 12,
      lang: "bg",
  ...
  languageSkills: [
    {
      ...
      languages: ["Bulgarian - Native", "English - C1", "Russian - B1"]
    },
    {
      id: 16,
      lang: "en",
      title: "Езикови умения",
      languages: ["Български - Роден", "Английски - C1", "Руски - B1"]
    }
  ],
  completedCourses: [
    {
...
const getters = {
  allTops: state => {
    if (state.language === "en") {
      return state.top[0];
    } else if (state.language === "bg") {
      return state.top[1];
    }
  },
  allPersonalData: state => {
    if (state.language === "en") {
      return state.personalData[0];
    } else if (state.language === "bg") {
      return state.personalData[1];
    }
  },
  allContactData: state => {
    if (state.language === "en") {
      return state.contactData[0];
    } else if (state.language === "bg") {
      return state.contactData[1];
    }
  },
  allWorkExpirience: state => {
    if (state.language === "en") {
      return state.workExpirience[0];
    } else if (state.language === "bg") {
      return state.workExpirience[1];
    }
  },
  allEducations: state => {
    if (state.language === "en") {
      return state.education[0];
    } else if (state.language === "bg") {
      return state.education[1];
    }
  },
  allPortfolios: state => {
    if (state.language === "en") {
  ...
  allProgrammingSkills: state => {
    if (state.language === "en") {
      return state.progammingSkills[0];
    } else if (state.language === "bg") {
      return state.progammingSkills[1];
    }
  },
  allLanguages: state => {
    if (state.language === "en") {
      return state.languageSkills[0];
    } else if (state.language === "bg") {
      return state.languageSkills[1];
    }
  },
  allCompletedCourses: state => {
    if (state.language === "en") {
      return state.completedCourses[0];
    } else if (state.language === "bg") {
      return state.completedCourses[1];
    }
  },
  allViews: state => {
    if (state.language === "en") {
  ...
  allAchievements: state => {
    if (state.language === "en") {
      return state.professionalAchievements[0];
    } else if (state.language === "bg") {
      return state.professionalAchievements[1];
    }
  }
};
